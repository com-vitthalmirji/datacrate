...
/// no memory limit at all. See docs/internals/notes/decisions.md, M3.8
/// single-node oracle memory-limit entry.
...
async fn run() -> Result<(), CliError> {
    ...
    // docs/internals/notes/decisions.md, M3.8 single-node oracle join-strategy entry.
